...
use App\Http\Controllers\DocumentGovernanceNotificationPreferenceController;
...
Route::middleware(['auth:sanctum', 'account.enabled', 'verified'])->group(function (): void {
    ...
    Route::get('/workspaces/{workspacePublicId}/governance-notification-preferences', [DocumentGovernanceNotificationPreferenceController::class, 'show']);
    Route::put('/workspaces/{workspacePublicId}/governance-notification-preferences/workspace', [DocumentGovernanceNotificationPreferenceController::class, 'updateWorkspace']);
    Route::put('/workspaces/{workspacePublicId}/governance-notification-preferences/personal', [DocumentGovernanceNotificationPreferenceController::class, 'updatePersonal']);
