    ...
    public function rules(): array
    {
        ...
        $rules = array_merge($base, match ($this->route()?->getName()) {
            ...
            'ingestion.extraction-artifact.acknowledge' => [
                ...
                'element_count' => ['required', 'integer', 'min:0', 'max:'.max(1, (int) config('ingestion.orchestration.extraction_artifact_max_elements'))],
                'warning_count' => ['required', 'integer', 'min:0', 'max:'.max(0, (int) config('ingestion.orchestration.extraction_artifact_max_warnings'))],
