...
final class Exp0006Definition
{
    public const RUN_ID = 'EXP-0006-adr0022-v4-consolidated-engineering-confirmation';

    public const PURPOSE = 'Confirm the bounded location/entity and temporal/historical corrections across the complete immutable engineering population.';
