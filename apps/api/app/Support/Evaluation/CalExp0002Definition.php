...
final class CalExp0002Definition
{
    public const RUN_ID = 'CAL-EXP-0002-v3-evidence-threshold-calibration';
    ...
    public static function lineage(): array
    {
        return [
            'id' => self::RUN_ID,
            'purpose' => 'Execute one provider pass over the compatible Benchmark V3 calibration population and preserve complete pre-threshold lineage.',
            'benchmark' => [
